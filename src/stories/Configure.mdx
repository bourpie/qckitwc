...
<Meta title="Comment démarrer" />

<div className="sb-container">
  <div className='sb-section-title'>
    # Comment démarrer
    Voici les étapes vous permettant d'importer la librairie dans votre projet
    ### 1. Générer le solution
    Exécuter la commande pour builder la solution <code>npm run build</code>
    ### 2. importer les composants dans votre solution
    Copier le dossier dist dans votre projet
    ### 3. Installer les polices Roboto et opensans dans votre projet
    ### 4. Importer bootstrap dans votre projet
